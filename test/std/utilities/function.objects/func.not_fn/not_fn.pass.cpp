...
struct MoveOnlyCallable {
  ...
  MoveOnlyCallable(MoveOnlyCallable&& other) : value(other.value) {
...
template <class Ret = bool>
struct CopyCallable {
  CopyCallable(CopyCallable const& other) : value(other.value) {}

  CopyCallable(CopyCallable&& other) : value(other.value) {
    other.value = !other.value;
  }
...
struct ConstCallable {
  ConstCallable(ConstCallable const& other) : value(other.value) {}

  ConstCallable(ConstCallable&& other) : value(other.value) {
    other.value = !other.value;
  }
...
struct NoExceptCallable {
  NoExceptCallable(NoExceptCallable const& other) : value(other.value) {}

  template <class... Args>
  Ret operator()(Args&&...) noexcept {
    return Ret{value};
  }
...
void call_operator_forwarding_test() {
  ...
  { // test multi arg
    ...
    Fn::check_call<int&&, const double&&, std::string&, std::string&&>(
...
void test_lwg2767() {
  ...
  struct F {
    bool operator()(Abstract&&) { return false; }
  };
  {
    Derived d;
    Abstract& a = d;
